...
pub enum PermissionError {
  ...
  #[error("{0}")]
  NetDescriptorParse(#[from] ::deno_permissions_extended::NetDescriptorParseError),
  #[error("{0}")]
  SysDescriptorParse(#[from] ::deno_permissions_extended::SysDescriptorParseError),
  #[error("{0}")]
  RunDescriptorParse(#[from] ::deno_permissions_extended::RunDescriptorParseError),
}
